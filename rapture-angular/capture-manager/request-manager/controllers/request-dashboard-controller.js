angular.module('raptureAngular.captureManager.request')
    .controller('dashboardController', [
        '$scope', '$http', '$modal', 'raptureAngularTemplatePath',
        function($scope, $http, $modal, raptureAngularTemplatePath) {
            ...
            (function(d3) {
                ...
                function drawDownloadCircle(d3item, index) {
                    ...
                    meter.data(
                        ...
                        .transition()
                        .duration(duration)
                        .attrTween('d', tweenArcBackground({
                            value: 1
                        }));
                    ...
                    var foreground = meter.data(
                        ...
                        .delay(1000 * index)
                        .duration(duration)
                        .attrTween('d', tweenArcForeground({
                            value: value / 1000
                        }));
                ...
                function visualizeDownloadTimeline(selector, data) {
                    ...
                    drawArea(
                        ...
                        data.filter(
                            function(datum) {
                                return datum.type === 'BloombergSAPI';
                            }
                        ),
                        'red',
                        1
                    ...
                    drawArea(
                        ...
                        data.filter(
                            function(datum) {
                                return datum.type === 'NorthernTrust';
                            }
                        ),
                        'purple',
                        2
